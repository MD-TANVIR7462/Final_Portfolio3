      ...
      <div className="max-w-6xl mx-auto px-5">
        <div className="bg-[#111111] text-default-100 rounded px-2 md:px-20 py-10">
          ...
          <div className="p-5">
            ...
            <p className="mt-2">
              Created At: <span className="text-sm text-default-400">{moment(blog?.createdAt).format("LL")}</span>
            </p>
            <p className="mt-2 md:text-right">
              Written By: <span>MD.Tajul Islam Tanvir</span>
            </p>
          </div>
        </div>
      </div>
